...
// Призы по умолчанию
let PRIZES = [
  { points: 1000,  name: "Любознательный" },
  { points: 2000,  name: "Начинающий эрудит" },
  { points: 3000,  name: "Эрудит" },
  { points: 5000,  name: "Интеллектуал" },
  { points: 7500,  name: "Мозговой штурмовик" },
  { points: 10000, name: "Гуру логики" },
  { points: 15000, name: "Повелитель викторин" },
  { points: 20000, name: "Ходячая энциклопедия" },
  { points: 25000, name: "Живой гугл" },
  { points: 30000, name: "Гроссмейстер мыслей" },
  { points: 40000, name: "Мегамозг" },
  { points: 50000, name: "Анатолий Вассерман" }
];
...
// состояние слова
let currentWord = "ФАНТАСМАГОРИЧЕСКИЙ";
let currentHint = "Как описать одним словом совсем нереальные, странные, будто из сна события или картины?";
